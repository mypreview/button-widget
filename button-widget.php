...
if ( ! class_exists( 'Button_Widget' ) ) :
    ...
    final class Button_Widget {
        ...
        public function enqueue() {
            ...
            wp_register_style( 'button-widget-style', sprintf( '%sassets/css/style%s.css', BUTTON_WIDGET_DIR_URL, $min ), array( 'wp-color-picker' ), BUTTON_WIDGET_VERSION, 'screen' );
            wp_register_script( 'button-widget-script', sprintf( '%sassets/js/script%s.js', BUTTON_WIDGET_DIR_URL, $min ), array( 'jquery', 'wp-color-picker' ), BUTTON_WIDGET_VERSION, true );
